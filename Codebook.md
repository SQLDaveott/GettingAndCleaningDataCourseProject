...
The following files were added:
	...
	-‘Codebook.md’ – Original ‘Readme.txt’ with modifications, this document
...
1. Merge the training and the test sets to create one data set.
	...
	'train/X_train.txt' and 'test/X_test.txt' - Train and Test sets row bound (rbind) and assign column names found in 'features.txt' to create a Master Dataset.
